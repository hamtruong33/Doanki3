...
jQuery(window).load(function($){
	$ = typeof($ !== 'funtion') ? jQuery : $;
		var obj_class 		= $('#content .row').find('.product-layout').parent(),
		    ...
		    $minPrice_new 		= 45,
		    $maxPrice_new 		= 101,
		    url 				= 'indexb152.html?route=product/category&amp;path=17';
		text_search			= "";
	...
	$('#submit_text_search').on("click",function(){
		...
		$.ajax({
			type: 'POST',
			url:'http://opencart.opencartworks.com/themes/so_maxshop/layout9/index.php?route=product/category&path=17',
			data: {
				isFilterShopBy		: 1,
